...
__all__ = [
    "MdeCompleteUnderlinedHeaderCommand",
    "MdeConvertToAtxCommand",
    "MdeFixAllUnderlinedHeadersCommand"
]
...
class MdeCompleteUnderlinedHeaderCommand(MDETextCommand):
...
class MdeFixAllUnderlinedHeadersCommand(MDETextCommand):
...
class MdeConvertToAtxCommand(MDETextCommand):
